...
export default function CategoriesSection({categories: products, buttonRedirecting: buttonRedirecting}: {
    categories: any[],
    buttonRedirecting: any
}) {
        ...
        <div className="relative w-full">
            <div className="bg-awpastel py-16">
                <div className="w-full text-center uppercase text-awsalmon text-sm tracking-widest">
                    • • • • • les catégories • • • • • les catégories • • • • • les catégories • • • • • les catégories
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl py-16 mx-auto items-center">
                    <div className="relative h-64 flex items-center justify-center">
                        <div className="absolute -bottom-4 -left-16 w-52 h-96 z-10">
                            <Image src={categoriesLeftImages["0"]} alt={""}
                                   className="object-cover object-right rounded-full" fill/>
                        </div>
                    ...
                    <div className="flex flex-col gap-6 items-center">
                        {uniqueCategories.map((cat, idx) => (
                            ...
                            >
                                <span
                                    className="transition-colors duration-300 group-hover:text-awsalmon">{cat.name}</span>
                                {selected === idx && (
                                    <svg
                        ...
                        <a href={buttonRedirecting.url}
                           className="mt-6 group relative inline-flex items-center overflow-hidden bg-awblack p-3 pr-0 hover:pr-3 text-awgraylight transition-all duration-300 hover:bg-awpink hover:text-black">
