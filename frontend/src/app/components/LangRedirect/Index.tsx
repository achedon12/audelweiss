...
import HighlightedText from "@/app/components/HighlightedText/Index";
    ...
    return (
        <section className="dark:bg-black dark:text-gray-100">
            <div
                ...
                <div
                    className="flex flex-col justify-center p-6 text-center rounded-lg lg:max-w-md xl:max-w-lg lg:text-left">
                    <HighlightedText
